...
$res = $cunity->getDb()->query("select title, text from ".$cunity->getConfig("db_prefix")."pages where slug='".$_GET['id']."'");
$data = mysql_fetch_assoc($res);
$tplEngine->Assign('TITLE', $data['title']);
$tplEngine->Template('pages');
    $tplEngine->Assign("TITLE", $data['title']);
